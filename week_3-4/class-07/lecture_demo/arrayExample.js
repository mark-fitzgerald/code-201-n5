...
function buildTable() {
  ...
  var tableContents = tableHeaderRow;
  // var message = "Students in the class:";
  for (var index = 0; index < students.length; index++) {
    // message += "\n  " + students[index];
    var studentRow = "<tr><td>"+students[index][0]+"</td>";
    studentRow += "<td>"+students[index][1]+"</td>";
    studentRow += "<td class='email'>"+students[index][2]+"</td></tr>";
    tableContents += studentRow;
  }
  studentTable.innerHTML = tableContents + "<tr><td colspan='2'>Total Students:</td><td>" + students.length + "</td></tr>";
  // console.log(message);
}
